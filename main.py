...
async def help_command(update, context):
    ...
    help_text += f"/setlanguage - {descriptions['setlanguage_description']}\n"
...
async def handle_audio(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(response_text, parse_mode=constants.ParseMode.MARKDOWN, reply_markup=reply_markup)
